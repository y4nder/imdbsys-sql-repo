...
LEFT JOIN	employee mgr on mgr.empno = d.mgrno
WHERE		e.birthdate < mgr.birthdate AND e.hiredate < mgr.hiredate AND (d.deptname LIKE '%CENTER%' OR d.deptname LIKE '%SYSTEM%')
